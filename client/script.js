...
document.getElementById('query-button').addEventListener('click', sendQueryButton)
...
/*
    ...
    Next, create an object called body inside the function. It should have one key-value pair. The key should be newFood (make sure to match the 
        case and spelling exactly) and the value should be the value of the food input. 
    ...
    Use a .then to handle the promise returned from the axios call. Pass a callback function to the .then. Inside that callback, console log the 
    res.data. 
...
const createFood = () {
    ...
    axios('http://localhost:3000/query-test/food', body)
    .then((res) => {
        console.log(res.data)
    })
}
